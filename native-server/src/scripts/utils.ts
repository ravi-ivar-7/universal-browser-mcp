 ...
 * - Windows: %LOCALAPPDATA%/universal-browser-mcp/logs
...
export function getLogDir(): string {
  ...
  if (os.platform() === 'darwin') {
    return path.join(homedir, 'Library', 'Logs', 'universal-browser-mcp');
    ...
    return path.join(xdgState, 'universal-browser-mcp', 'logs');
  }
}
