...
LOG_DIR="/Users/hang/code/tencent/ai/universal-browser-mcp/app/native-server/dist/logs" # Or a directory you choose that you are sure has write permissions
