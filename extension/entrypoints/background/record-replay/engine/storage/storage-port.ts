...
export interface FlowsStore {
  ...
  list(): Promise<Flow[]>;
  /** Get single Flow */
  get(id: FlowId): Promise<Flow | null>;
  /** Save Flow */
...
export interface RunsStore {
  ...
  patch(id: RunId, patch: Partial<RunRecord>): Promise<void>;
}
...
export interface EventsStore {
   ...
   * @description In single transaction: read RunRecord.nextSeq -> write event -> increment nextSeq
