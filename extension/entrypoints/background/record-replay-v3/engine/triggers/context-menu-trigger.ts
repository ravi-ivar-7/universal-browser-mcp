...
const DEFAULT_CONTEXTS: chrome.contextMenus.ContextType[] = ['page' as chrome.contextMenus.ContextType];
        ...
        chrome.contextMenus.create(
          {
            id: menuItemId,
            title: title,
            contexts: normalizeContexts(contexts) as [chrome.contextMenus.ContextType, ...chrome.contextMenus.ContextType[]],
          },
          () => {
